...
// tests for NonFungibleTokensMetadataList
void main() {
  final instance = NonFungibleTokensMetadataList();

  group('test NonFungibleTokensMetadataList', () {
    ...
    // List<NonFungibleTokenMetadata> results (default value: const [])
