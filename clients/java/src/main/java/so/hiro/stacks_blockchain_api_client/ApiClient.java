...
import so.hiro.stacks_blockchain_api_client.auth.Authentication;
import so.hiro.stacks_blockchain_api_client.auth.HttpBasicAuth;
import so.hiro.stacks_blockchain_api_client.auth.HttpBearerAuth;
import so.hiro.stacks_blockchain_api_client.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://stacks-node-api.mainnet.stacks.co";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://stacks-node-api.mainnet.stacks.co
