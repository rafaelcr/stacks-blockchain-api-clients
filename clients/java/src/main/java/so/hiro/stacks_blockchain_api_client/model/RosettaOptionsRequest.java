 ...
 */
@ApiModel(description = "This endpoint returns the version information and allowed network-specific types for a NetworkIdentifier. Any NetworkIdentifier returned by /network/list should be accessible here. Because options are retrievable in the context of a NetworkIdentifier, it is possible to define unique options for each network.")
...
public class RosettaOptionsRequest {
  ...
  public RosettaOptionsRequest() { 
  }

  public RosettaOptionsRequest networkIdentifier(Object networkIdentifier) {
  ...
  **/
  ...
  public RosettaOptionsRequest metadata(Object metadata) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    RosettaOptionsRequest rosettaOptionsRequest = (RosettaOptionsRequest) o;
    return Objects.equals(this.networkIdentifier, rosettaOptionsRequest.networkIdentifier) &&
        Objects.equals(this.metadata, rosettaOptionsRequest.metadata);
  }
  ...
  public String toString() {
    ...
    sb.append("class RosettaOptionsRequest {\n");
