...
/**
 * AddressTransactionWithTransfersFtTransfers Class Doc Comment
 *
 * @category Class
 * @package  StacksBlockchainApi
 * @author   OpenAPI Generator team
 ...
 */
class AddressTransactionWithTransfersFtTransfers implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddressTransactionWithTransfers_ft_transfers';
     ...
     *
     * @param string $asset_identifier Fungible Token asset identifier.
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param string $amount Amount transferred as an integer string. This balance does not factor in possible SIP-010 decimals.
     *
     * @return self
     */
