...
/**
 * ReadOnlyFunctionArgs Class Doc Comment
 *
 * @category Class
 ...
 */
class ReadOnlyFunctionArgs implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReadOnlyFunctionArgs';
     ...
     * Sets sender
     *
     * @param string $sender The simulated tx-sender
     *
     * @return self
     */
     ...
     * Sets arguments
     *
     * @param string[] $arguments An array of hex serialized Clarity values
     *
     * @return self
     */
