...
/**
 * RosettaAccountBalanceRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class RosettaAccountBalanceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RosettaAccountBalanceRequest';
    ...
    protected static $openAPITypes = [
        ...
        'account_identifier' => '\StacksBlockchainApi\Model\RosettaAccount',
        'block_identifier' => 'AnyOfObjectObject'
    ];
     ...
     *
     * @return \StacksBlockchainApi\Model\RosettaAccount
     */
     ...
     *
     * @param \StacksBlockchainApi\Model\RosettaAccount $account_identifier account_identifier
     *
     * @return self
     */
     ...
     *
     * @param AnyOfObjectObject|null $block_identifier When fetching data by BlockIdentifier, it may be possible to only specify the index or hash. If neither property is specified, it is assumed that the client is making a request at the current block.
     *
     * @return self
     */
