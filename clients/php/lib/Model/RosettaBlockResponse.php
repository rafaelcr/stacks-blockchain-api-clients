...
/**
 * RosettaBlockResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class RosettaBlockResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RosettaBlockResponse';
    ...
    protected static $openAPITypes = [
        'block' => '\StacksBlockchainApi\Model\RosettaBlock',
        'other_transactions' => '\StacksBlockchainApi\Model\OtherTransactionIdentifier[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['other_transactions'] = $data['other_transactions'] ?? null;
    }
     ...
     * Gets block
     *
     * @return \StacksBlockchainApi\Model\RosettaBlock|null
     */
     ...
     * Sets block
     *
     * @param \StacksBlockchainApi\Model\RosettaBlock|null $block block
     *
     * @return self
     */
     ...
     *
     * @return \StacksBlockchainApi\Model\OtherTransactionIdentifier[]|null
     */
     ...
     *
     * @param \StacksBlockchainApi\Model\OtherTransactionIdentifier[]|null $other_transactions Some blockchains may require additional transactions to be fetched that weren't returned in the block response (ex: block only returns transaction hashes). For blockchains with a lot of transactions in each block, this can be very useful as consumers can concurrently fetch all transactions returned.
     *
     * @return self
     */
