...
/**
 * SigningPayload Class Doc Comment
 *
 * @category Class
 ...
 */
class SigningPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SigningPayload';
     ...
     * Sets address
     *
     * @param string|null $address [DEPRECATED by account_identifier in v1.4.4] The network-specific address of the account that should sign the payload.
     *
     * @return self
     */
     ...
     *
     * @param object|null $account_identifier account_identifier
     *
     * @return self
     */
     ...
     * Sets signature_type
     *
     * @param string|null $signature_type SignatureType is the type of a cryptographic signature.
     *
     * @return self
     */
