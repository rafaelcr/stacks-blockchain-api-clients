...
module StacksBlockchainApi
  ...
  class ChainTip
    ...
    attr_accessor :index_block_hash
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `StacksBlockchainApi::ChainTip` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `StacksBlockchainApi::ChainTip`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'index_block_hash')
        self.index_block_hash = attributes[:'index_block_hash']
      end
    ...
    def list_invalid_properties
      ...
      if @index_block_hash.nil?
        invalid_properties.push('invalid value for "index_block_hash", index_block_hash cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @index_block_hash.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          index_block_hash == o.index_block_hash &&
    ...
    def hash
      [block_height, block_hash, index_block_hash, microblock_hash, microblock_sequence].hash
    end
