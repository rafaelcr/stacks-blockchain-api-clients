...
module StacksBlockchainApi
  class FungibleTokenMetadata
    ...
    attr_accessor :image_canonical_uri
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `StacksBlockchainApi::FungibleTokenMetadata` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `StacksBlockchainApi::FungibleTokenMetadata`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'image_canonical_uri')
        self.image_canonical_uri = attributes[:'image_canonical_uri']
      end
    ...
    def list_invalid_properties
      ...
      if @token_uri.nil?
        invalid_properties.push('invalid value for "token_uri", token_uri cannot be nil.')
      end
      ...
      if @image_canonical_uri.nil?
        invalid_properties.push('invalid value for "image_canonical_uri", image_canonical_uri cannot be nil.')
      end
    ...
    def valid?
      return false if @token_uri.nil?
      return false if @name.nil?
      return false if @description.nil?
      return false if @image_uri.nil?
      return false if @image_canonical_uri.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          image_canonical_uri == o.image_canonical_uri &&
          symbol == o.symbol &&
          decimals == o.decimals &&
          tx_id == o.tx_id &&
    ...
    def hash
      [token_uri, name, description, image_uri, image_canonical_uri, symbol, decimals, tx_id, sender_address].hash
    end
