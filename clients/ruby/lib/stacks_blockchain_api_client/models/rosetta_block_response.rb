...
module StacksBlockchainApi
  ...
  class RosettaBlockResponse
    ...
    attr_accessor :other_transactions
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `StacksBlockchainApi::RosettaBlockResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `StacksBlockchainApi::RosettaBlockResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'other_transactions')
        if (value = attributes[:'other_transactions']).is_a?(Array)
          self.other_transactions = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          block == o.block &&
          other_transactions == o.other_transactions
    end
