...
module StacksBlockchainApi
  ...
  class RosettaConstructionParseResponse
    ...
    attr_accessor :account_identifier_signers
    ...
    def self.openapi_types
      {
        ...
        :'signers' => :'Array<AnyOfstring>',
        :'account_identifier_signers' => :'Array<Object>',
        :'metadata' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `StacksBlockchainApi::RosettaConstructionParseResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `StacksBlockchainApi::RosettaConstructionParseResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'account_identifier_signers')
        if (value = attributes[:'account_identifier_signers']).is_a?(Array)
          self.account_identifier_signers = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          signers == o.signers &&
          account_identifier_signers == o.account_identifier_signers &&
          metadata == o.metadata
    end
    ...
    def hash
      [operations, signers, account_identifier_signers, metadata].hash
    end
