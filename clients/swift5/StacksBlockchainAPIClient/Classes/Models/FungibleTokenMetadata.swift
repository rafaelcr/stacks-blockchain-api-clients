...
public struct FungibleTokenMetadata: Codable, JSONEncodable, Hashable {
    ...
    public init(tokenUri: String, name: String, description: String, imageUri: String, imageCanonicalUri: String, symbol: String, decimals: Double, txId: String, senderAddress: String) {
